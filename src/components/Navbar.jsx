...
const styles = {
    navbarWrapper: `px-2 sm:px-4 py-2.5 w-full z-20 border-b-default border-gray-600`,
    navbarContainer: `container flex flex-wrap items-center justify-between mx-auto`,
